    ...
    module V1
        class CreateByCash < Operation
            ...
            def process
                ...
                # if s == 0
                NotificationWorker.perform_async(Constant::CASHIER, order.id, user.id, 1, 0)
                # else
                # end
            ...
            def do_transaction!
                begin
                    ActiveRecord::Base.transaction do
                        ...
                        order.update!(total: total, table_number: table_number, cooking_status: 1, payment_method: 1)
                    end
